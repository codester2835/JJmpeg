...
# JJmpeg has many features, none of which I claim as my own. I have simply wrapped existing tools and libraries to provide a simplified interface for users. I do \_\_not\_\_ claim responsibility for any file or system damage.  Similiarly, I do \_\_not\_\_ claim responsibility for creating any DRM bypassing tools.  I \_\_do \*\*not\*\*\_\_ promote piracy in any way shape or form.
...
# \_\_Insure you are running in administrator command prompt.\_\_
...
# for /f "usebackq tokens=2\*" %A in (`reg query "HKLM\\SYSTEM\\CurrentControlSet\\Control\\Session Manager\\Environment" /v Path`) do reg add "HKLM\\SYSTEM\\CurrentControlSet\\Control\\Session Manager\\Environment" /v Path /t REG\_EXPAND\_SZ /d "%B;%CD%" /f
...
# jjmpeg help\_advanced <insert path here>
...
# I (the creator) do \_\_NOT\_\_ promote piracy, or theft in any way.  This project is to be used \*\*ONLY\*\* for archival\\personal uses.
